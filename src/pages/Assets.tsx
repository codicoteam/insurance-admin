...
const MOCK_ASSETS: Asset[] = [
  {
    ...
    description: "Electric luxury sedan, full coverage",
    insuredValue: 89000,
    purchaseDate: "2022-03-15",
    serialNumber: "5YJSA1E26MF123456",
  ...
  },
  {
    ...
    description: "3-bed, 2-bath on 5th Ave",
    insuredValue: 1250000,
    purchaseDate: "2019-07-01",
    serialNumber: "PROP-MN-00421",
    location: "New York, NY",
    riskLevel: "Medium",
    status: "Active",
  },
  {
    ...
    type: "Vehicle",
    name: "2021 BMW X5",
    description: "SUV, comprehensive plan",
    insuredValue: 62000,
    purchaseDate: "2021-11-20",
    serialNumber: "5UXCR6C05M9D23456",
  ...
  },
  {
    ...
    description: "Industrial precision equipment",
    insuredValue: 145000,
    purchaseDate: "2020-05-10",
    serialNumber: "CNC-HVY-2020-7712",
    location: "Chicago, IL",
    riskLevel: "High",
    status: "Under Review",
  },
  {
    ...
    policyId: "POL-003",
    type: "Commercial",
    name: "Retail Store – Chicago Loop",
    description: "Commercial premises, ground floor",
    insuredValue: 890000,
    purchaseDate: "2018-01-15",
    serialNumber: "COMM-CHI-00115",
    location: "Chicago, IL",
    riskLevel: "Medium",
    status: "Active",
  },
  {
    ...
    description: "Fleet truck, liability + collision",
    insuredValue: 38000,
    purchaseDate: "2019-09-05",
    serialNumber: "1FTEW1E58KFB45678",
    location: "Houston, TX",
    riskLevel: "Medium",
    status: "Expired",
  },
  {
    ...
    description: "20,000 sqft storage facility",
    insuredValue: 450000,
    purchaseDate: "2017-06-30",
    serialNumber: "PROP-HOU-00230",
    location: "Houston, TX",
    riskLevel: "High",
    status: "Active",
  },
  {
    ...
    policyId: "POL-005",
    type: "Equipment",
    name: "MRI Scanner – Model 3T",
    description: "Medical imaging equipment, clinic",
    insuredValue: 1200000,
    purchaseDate: "2021-02-28",
    serialNumber: "MRI-3T-2021-00891",
    location: "Boston, MA",
    riskLevel: "High",
    status: "Active",
  },
  {
    ...
    description: "Sports car, agreed value policy",
    insuredValue: 115000,
    purchaseDate: "2023-01-10",
    serialNumber: "WP0AB2A96PS123789",
    location: "Miami, FL",
    riskLevel: "Low",
    status: "Active",
  },
  {
    ...
    description: "12-floor office building, downtown",
    insuredValue: 4200000,
    purchaseDate: "2015-11-01",
    serialNumber: "COMM-SEA-00078",
    location: "Seattle, WA",
    riskLevel: "Medium",
    status: "Active",
  },
  {
    ...
    serialNumber: "SOL-500KW-2022-034",
    location: "Phoenix, AZ",
    riskLevel: "Low",
    status: "Active",
  },
  {
    ...
    policyId: "POL-009",
    type: "Vehicle",
    name: "2020 Harley-Davidson Road King",
    description: "Motorcycle, agreed value",
    insuredValue: 22000,
    purchaseDate: "2020-04-22",
    serialNumber: "1HD1KRM1XLB123901",
    location: "Denver, CO",
    riskLevel: "High",
    status: "Damaged",
  },
  {
    ...
    policyId: "POL-009",
    type: "Property",
    name: "Denver Ski Cabin",
    description: "Mountain property, seasonal use",
    insuredValue: 675000,
    purchaseDate: "2016-12-10",
    serialNumber: "PROP-DEN-00567",
    location: "Denver, CO",
    riskLevel: "Medium",
    status: "Active",
  },
  {
    ...
    policyId: "POL-010",
    type: "Commercial",
    name: "Portland Food Hall",
    description: "Multi-tenant F&B commercial space",
    insuredValue: 1800000,
    purchaseDate: "2021-05-20",
    serialNumber: "COMM-POR-00341",
  ...
  },
  {
    ...
    description: "Backup power for data center",
    insuredValue: 78000,
    purchaseDate: "2020-10-01",
    serialNumber: "GEN-500KVA-00214",
    location: "Austin, TX",
    riskLevel: "Low",
    status: "Active",
  },
...
const TypeIconLarge: React.FC<{ type: string }> = ({ type }) => {
  ...
  return (
    <div
      className={`w-12 h-12 rounded-xl bg-gradient-to-br ${styles[type as keyof typeof styles]} flex items-center justify-center text-white shadow-md`}
    >
...
const RiskBadge: React.FC<{ level: Asset["riskLevel"] }> = ({ level }) => {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold border ${styles[level]}`}
    >
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        {/* Modal header */}
        <div
          className={`px-6 py-5 border-b border-gray-200 flex items-center justify-between rounded-t-2xl ${isView ? "bg-gradient-to-r from-blue-50 to-indigo-50" : "bg-white"}`}
        >
          <div className="flex items-center gap-3">
            <div
              className={`p-2.5 rounded-xl ${mode === "add" ? "bg-blue-100" : mode === "edit" ? "bg-green-100" : "bg-indigo-100"}`}
            >
              {mode === "add" ? (
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">
                {mode === "add"
                  ? "Fill in asset information below"
                  : mode === "edit"
                    ? `Editing ${asset?.id}`
                    : asset?.id}
              </p>
...
export default function PolicyAssetsPage() {
  ...
  const totalInsuredValue = useMemo(
    () => assets.reduce((s, a) => s + a.insuredValue, 0),
    [assets],
  );
  ...
  const uniquePolicies = useMemo(
    () => new Set(assets.map((a) => a.policyId)).size,
    [assets],
  );
  ...
  const stats = [
    {
      label: "Total Assets",
      value: assets.length,
      sub: `Across ${uniquePolicies} policies`,
      icon: Package,
      color: "blue",
    },
    {
      label: "Insured Value",
      value: fmt(totalInsuredValue),
      sub: "Combined portfolio value",
      icon: DollarSign,
      color: "green",
    },
    {
      label: "Active Assets",
      value: activeCount,
      sub: `${Math.round((activeCount / assets.length) * 100)}% of total`,
      icon: Activity,
      color: "teal",
    },
    {
  ...
  const actionButtons = [
    {
      ...
      label: "Add Vehicle",
      onClick: () => {
        setFormData({ ...EMPTY_FORM, type: "Vehicle" });
        setModal({ open: true, mode: "add", asset: null });
      },
      color: "blue",
    },
    {
      ...
      label: "Add Property",
      onClick: () => {
        setFormData({ ...EMPTY_FORM, type: "Property" });
        setModal({ open: true, mode: "add", asset: null });
      },
      color: "purple",
    },
    {
      ...
      label: "Add Equipment",
      onClick: () => {
        setFormData({ ...EMPTY_FORM, type: "Equipment" });
        setModal({ open: true, mode: "add", asset: null });
      },
      color: "teal",
    },
    {
      ...
      onClick: () => {
        setFormData({ ...EMPTY_FORM, type: "Commercial" });
        setModal({ open: true, mode: "add", asset: null });
      },
      color: "indigo",
    },
  ...
  const filtered = useMemo(() => {
    ...
    return assets.filter((a) => {
      const matchSearch =
        ...
        a.policyId.toLowerCase().includes(q) ||
  ...
  const openEdit = (a: Asset) => {
    setFormData({
      ...
      insuredValue: String(a.insuredValue),
  ...
  const openView = (a: Asset) =>
    setModal({ open: true, mode: "view", asset: a });
  const closeModal = () => {
    setModal({ open: false, mode: "add", asset: null });
  ...
  const validate = (): boolean => {
    ...
    if (
      ...
      isNaN(Number(formData.insuredValue)) ||
      Number(formData.insuredValue) <= 0
    )
      e.insuredValue = "Enter a valid insured value";
    if (!formData.location.trim()) e.location = "Location is required";
    if (!formData.serialNumber.trim())
      e.serialNumber = "Serial / registration number is required";
    setFormErrors(e);
  ...
  const handleSave = () => {
    ...
    if (modal.mode === "add") {
      ...
      setAssets((p) =>
        p.map((a) =>
          a.id === modal.asset!.id
            ? { ...a, ...formData, insuredValue: Number(formData.insuredValue) }
            : a,
        ),
      );
    }
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Manage and monitor insured assets across all policies
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6 py-6">
            ...
            <div className="mt-8 flex items-start gap-3 p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <p className="text-blue-900 text-sm">
                This dashboard provides a comprehensive view of all insured
                assets. Monitor values, track risk levels, and manage asset
                details efficiently. High-risk assets require additional
