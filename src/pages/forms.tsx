...
export default function FormsDisclosuresOverview() {
  ...
  const policyStructure = [
    { label: 'Product', description: 'the plan', color: 'from-blue-500 to-blue-600' },
    { label: 'Version', description: 'edition of the plan', color: 'from-purple-500 to-purple-600' },
    { label: 'Coverage', description: 'protection provided', color: 'from-green-500 to-green-600' },
    { label: 'Rider', description: 'optional extra', color: 'from-orange-500 to-orange-600' },
    { label: 'Forms', description: 'paperwork to enroll or manage', color: 'from-pink-500 to-pink-600' },
    { label: 'Disclosures', description: 'legal explanations to the customer', color: 'from-teal-500 to-teal-600' }
  ];
          ...
          <div className="max-w-7xl mx-auto px-6 py-6 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-blue-100 p-6">
              ...
              <p className="text-gray-700 mb-6">
                ...
                official document used to collect information or define part of
                the insurance contract. Approved forms are required to issue
                and manage policies.
              </p>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-blue-100 p-6">
              ...
              <p className="text-gray-700 mb-6">
                ...
                is information the insurer must provide to ensure transparency
                about coverage, costs, risks, and rights.
              </p>
              ...
              <div className="grid lg:grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                  ...
                  <p className="text-sm text-purple-800">
                    Company explains exclusions, clauses, and fees before the
                    policy is finalized.
                  </p>
                </div>
              </div>
