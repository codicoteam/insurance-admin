...
const PricingRates = () => {
  ...
  const filteredTables = rateTables.filter((table) => {
    const matchesSearch =
      ...
      table.product.toLowerCase().includes(searchTerm.toLowerCase());
    const matchesStatus =
        ...
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Manage pricing rates across all insurance products
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-5 hover:shadow-md transition-shadow">
              ...
              <p className="text-xs text-gray-500 mt-1">Rate tables updated</p>
            </div>
          </div>
