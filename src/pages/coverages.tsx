...
const ProductConfigurationPage: React.FC = () => {
  ...
  const baseCoverages: Coverage[] = [
    { id: 'cov-001', name: 'Death Benefit', type: 'Primary Coverage', limit: '$100,000', included: true },
    { id: 'cov-002', name: 'Terminal Illness Benefit', type: 'Accelerated Benefit', limit: 'Up to 50%', included: true },
    { id: 'cov-003', name: 'Medical Costs Coverage', type: 'Healthcare', limit: '$25,000 annually', included: true },
    { id: 'cov-004', name: 'Property Damage', type: 'Liability', limit: '$50,000', included: true }
  ];

  const availableRiders: Rider[] = [
    { id: 'rid-001', name: 'Critical Illness Rider', category: 'Health', priceImpact: '+$45/month', priceType: 'Flat', underwritingRequired: true },
    { id: 'rid-002', name: 'Accidental Death & Dismemberment', category: 'Death Benefit', priceImpact: '+15%', priceType: 'Percentage', underwritingRequired: false },
    { id: 'rid-003', name: 'Waiver of Premium', category: 'Premium Protection', priceImpact: '+$12/month', priceType: 'Flat', underwritingRequired: true },
    { id: 'rid-004', name: 'Child Term Rider', category: 'Family', priceImpact: '+$18/month', priceType: 'Flat', underwritingRequired: false },
    { id: 'rid-005', name: 'Return of Premium', category: 'Investment', priceImpact: '+35%', priceType: 'Percentage', underwritingRequired: true }
  ];
        ...
        <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-white">
            ...
            <div className="max-w-7xl mx-auto px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Manage coverages and riders for this version</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6 py-6 space-y-6">
            ...
            <nav className="flex items-center text-sm text-gray-500">
              ...
              <a href="#" className="hover:text-blue-600">Term Life</a>
              <ChevronRight className="w-4 h-4 mx-2" />
            ...
            <div className="bg-white rounded-xl shadow-sm border border-blue-100 p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                ...
                <InfoItem label="Effective Date" value={new Date(productInfo.effectiveDate).toLocaleDateString()} />
                <InfoItem label="Last Updated" value={new Date(productInfo.lastUpdated).toLocaleDateString()} />
              </div>
            </div>
            ...
            >
              {availableRiders.map(rider => (
                <tr key={rider.id} className="hover:bg-blue-50">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600">{rider.category}</td>
                  <td className="px-6 py-4 font-medium">{rider.priceImpact}</td>
                  <td className="px-6 py-4">
                    {rider.underwritingRequired ? (
                      <span className="px-2 py-1 bg-amber-100 text-amber-700 text-xs rounded-full">Yes</span>
                    ) : (
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-700">
                  A product contains multiple versions. Each version defines base coverages and optional riders.
                </p>
              </div>
            </div>
  ...
  <div className="bg-white rounded-xl shadow-sm border border-blue-100">
    <div className="p-6 border-b border-blue-100 flex items-center justify-between">
      <div className="flex items-center gap-2">
        ...
        <span className="ml-2 px-2 py-0.5 bg-blue-100 text-blue-700 text-xs rounded-full">{badge}</span>
      </div>
