          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="flex items-end gap-2 h-40">
                {[65, 78, 82, 75, 88, 92, 85, 90, 95, 89, 96, 100].map(
                  (value, i) => (
                ...
                {[
                  {
                    ...
                    desc: "Overview of all claims activity",
                  },
                  {
                    name: "Payment Summary Report",
                    desc: "Detailed payment analysis",
                  },
                  {
                    name: "Adjuster Performance",
                    desc: "Claims handler metrics",
                  },
                  {
                    name: "Fraud Detection Report",
                    desc: "Suspicious claims flagged",
                  },
                ].map((report, i) => (
                  <button
                    key={i}
                    className="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 text-left"
                  >
                    <div>
