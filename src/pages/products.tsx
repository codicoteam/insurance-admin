...
export default function ProductVersionExplainer() {
  ...
  const versionTimeline = [
    {
      version: "Version 1",
      detail: "Initial release in 2018",
      year: "2018",
      color: "from-blue-500 to-blue-600",
    },
    {
      version: "Version 2",
      detail: "Pricing revision implemented in 2021",
      year: "2021",
      color: "from-purple-500 to-purple-600",
    },
    {
      version: "Version 3",
      detail: "Benefit enhancements introduced in 2024",
      year: "2024",
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-blue-100 p-6">
          ...
          <p className="text-gray-700 mb-6">
            A <span className="font-semibold text-blue-600">product</span>{" "}
            represents a primary insurance offering within the company's
            portfolio.
          </p>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-blue-100 p-6">
          ...
          <p className="text-gray-700 mb-6">
            A <span className="font-semibold text-purple-600">version</span>{" "}
            represents a release of a product at a specific time.
          </p>
          ...
          <div className="mt-8 flex gap-3 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <p className="text-sm text-blue-900">
              Customers typically remain on the version they purchased, ensuring
        ...
        <div className="text-center text-gray-500 text-sm pt-4">
          Clear product & version knowledge enables accurate administration and
          service.
        </div>
      </div>
    </div>
