...
const InsurancePolicyFullOverview: React.FC = () => {
  ...
  const timelineItems = [
    ...
    },
    {
      icon: Clock,
      title: "Renewal Date",
      description: "When coverage must be renewed",
    },
    {
      icon: DollarSign,
    ...
    },
    {
      ...
      description: "Filing time limits",
    },
    {
      icon: CheckCircle,
      title: "Maturity Date",
          ...
          <div className="bg-white border-b border-blue-100 shadow-sm">
            <div className="max-w-7xl mx-auto px-6 py-4">
              ...
              <p className="text-sm text-gray-600">
                Manage coverage, timelines and actions
              </p>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6 py-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {detailsItems.map((item, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="flex items-start gap-3 p-4 bg-white rounded-lg border border-gray-200 hover:border-blue-300"
                    >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {timelineItems.map((item, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="flex items-start gap-3 p-4 bg-white rounded-lg border border-gray-200 hover:border-purple-300"
                    >
            ...
            <div className="mt-10 flex items-start gap-3 p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <p className="text-blue-900 text-sm">
                This dashboard gives you a complete picture of your coverage,
                key dates, and the tools needed to manage your policy
                efficiently.
              </p>
            </div>
          </div>
