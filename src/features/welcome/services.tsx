...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description:
        "Dignified farewell planning with immediate payout and flexible payment options.",
      icon: Clock,
      features: [
        "Immediate Cover",
        "Pre-need Plans",
    ...
    },
    {
      ...
      description:
        "Secure your child's future with dedicated education savings plans.",
      icon: GraduationCap,
      features: [
        "Child Plan",
        "Higher Education",
  ...
  const whyChooseUs = [
    {
      ...
      description:
        "We ensure you get the most competitive rates in the market.",
      icon: Award,
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl text-gray-600">
              We don't just sell insurance - we build relationships based on
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {whyChooseUs.map((item, index) => (
              <div
                key={index}
                className="text-center p-6 bg-white rounded-3xl border border-gray-200 hover:shadow-xl transition-all hover:-translate-y-1"
              >
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-300 text-lg mb-8">
                  Use our free coverage calculator to get personalized
                  recommendations based on your lifestyle, family size, and
                  financial goals.
                </p>
