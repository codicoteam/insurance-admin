  ...
  const services = [
    {
      ...
      description:
        "Protect your loved ones with comprehensive life coverage plans tailored to your needs.",
      icon: Shield,
    ...
    },
    {
      ...
      description:
        "Complete protection for your vehicles with comprehensive and collision coverage.",
      icon: TrendingUp,
      features: [
        "Auto Insurance",
        "Motorcycle",
    ...
    },
    {
      ...
      description:
        "Quality healthcare coverage with extensive network of hospitals and wellness benefits.",
      icon: Users,
      features: [
        "Individual Plans",
        "Family Floater",
    ...
    },
    {
      ...
      description:
        "Safeguard your home and business properties against damages and losses.",
      icon: Building2,
      features: [
        "Home Insurance",
        "Renters Cover",
    ...
    },
    {
      ...
      description:
        "Comprehensive protection for your business operations and professional liabilities.",
      icon: Briefcase,
      features: [
        "General Liability",
      ...
      image:
        "https://images.unsplash.com/photo-1664575602554-2087b04935a5?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    },
    {
      title: "Travel Insurance",
      description:
        "Stay protected wherever you go with comprehensive travel coverage.",
      icon: Target,
      features: [
        "Trip Cancellation",
        "Medical Evacuation",
  ...
  const howItWorks = [
    {
      ...
      description:
        "Select from our range of insurance products tailored to your specific needs.",
      icon: FileText,
      color: "from-blue-600 to-cyan-600",
    },
    {
      ...
      description:
        "Receive an accurate premium calculation instantly with our smart algorithm.",
      icon: Zap,
      color: "from-purple-600 to-pink-600",
    },
    {
      ...
      description:
        "Adjust coverage amounts, deductibles, and add-ons to fit your budget.",
      icon: Wallet,
      color: "from-emerald-600 to-teal-600",
    },
    {
      ...
      title: "Get Protected",
      description:
        "Sign digitally and get immediate coverage with instant policy issuance.",
      icon: ShieldCheck,
      color: "from-amber-600 to-orange-600",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      content:
        "InsureCore saved my business after a major fire. Their claims process was smooth and they paid out within 48 hours. I couldn't ask for a better insurance partner.",
      rating: 5,
      image: "RC",
    ...
    },
    {
      ...
      role: "Mother of Two",
      content:
        "When my husband passed away unexpectedly, InsureCore made sure our family was taken care of. The life insurance payout helped us keep our home and maintain our lifestyle.",
      rating: 5,
      image: "MG",
    ...
    },
    {
      ...
      content:
        "I've been with InsureCore for over 15 years. Their health insurance plan is comprehensive and affordable. The customer service is always helpful and responsive.",
      rating: 5,
      image: "JW",
      company: "Austin, TX",
    },
    {
      ...
      content:
        "Getting auto insurance through InsureCore was so easy. Their app is user-friendly and I love the telematics discount for safe driving. Saved 20% on my premium!",
      rating: 4,
      image: "PP",
      company: "Seattle, WA",
    },
    {
      ...
      content:
        "I recommend InsureCore to all my home buyers. Their homeowners insurance offers great coverage at competitive rates, and their claims service is top-notch.",
      rating: 5,
      image: "MT",
      company: "Chicago, IL",
    },
    {
      ...
      content:
        "As a nurse, I appreciate how InsureCore values preventative care. Their wellness programs and health screenings have helped me stay healthy and save on premiums.",
      rating: 5,
      image: "SA",
      company: "Boston, MA",
    },
        ...
        {heroSlides.map((slide, index) => (
          ...
          >
            ...
            <div className="absolute inset-0">
              ...
              />
              <div
                className={`absolute inset-0 bg-gradient-to-r ${slide.color} mix-blend-multiply opacity-90`}
              ></div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl text-gray-600">
              Thousands of families and businesses trust us for their insurance
              needs. Here's what we've achieved together.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-6 gap-6">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-2xl p-6 hover:shadow-lg transition-all text-center"
              >
      ...
      <div className="w-full bg-gradient-to-b from-gray-50 to-white py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl text-gray-600">
              From protecting your health and vehicle to securing your family's
              future, we offer tailored insurance solutions that give you peace
              of mind.
            </p>
          </div>
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  />
                  <div
                    className={`absolute inset-0 bg-gradient-to-r ${service.color} opacity-60 group-hover:opacity-40 transition-opacity`}
                  ></div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                We've simplified the insurance process so you can get the
                protection you need without any hassle. No paperwork, no
                ...
                {howItWorks.map((step) => (
                  <div key={step.step} className="flex gap-4">
                    <div className="flex-shrink-0">
                      <div
                        className={`w-14 h-14 bg-gradient-to-br ${step.color} rounded-xl flex items-center justify-center text-white font-bold text-xl`}
                      >
                        {step.step}
                      </div>
                    </div>
                    <div>
                      <div
                        className={`inline-flex items-center gap-2 bg-gradient-to-br ${step.color} bg-clip-text text-transparent font-bold mb-2`}
                      >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 mb-1">
                      95% of customers complete their purchase in under 10
                      minutes
                    </p>
                    <p className="text-sm text-gray-600">
                      Join thousands of satisfied customers who got covered
                      quickly and easily
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl text-gray-300">
              ...
              say about their experience with InsureCore.
            </p>
          </div>
      ...
      <div className="w-full bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Join over 75,000 satisfied customers who trust us with their
            insurance needs. Get your free quote today and experience the
            InsureCore difference.
          </p>
